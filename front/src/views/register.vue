    ...
    <div>
        <div class="container">
            <div class="login-form">
                <h1 class="h1" style="color:#000;fontSize:28px;">考务报名平台注册</h1>
                <el-form class="rgs-form">
                    ...
                    <el-form-item label="重复密码" class="input">
                        ...
                        <!--
                            <el-form-item label="工号" class="input" v-if="tableName=='laoshi'">
                                <el-input v-model="ruleForm.laoshiUuidNumber" autocomplete="off" placeholder="工号"  />
                           </el-form-item>
                        -->
                        ...
                        -->
                        <!--
                            <el-form-item label="院部" class="input" v-if="tableName=='laoshi'">
                                <el-input v-model="ruleForm.yuanbuTypes" autocomplete="off" placeholder="院部"  />
                           </el-form-item>
                        -->
                        ...
                        <!--
                            ...
                            <el-form-item label="学生头像" class="input" v-if="tableName=='xuesheng'">
                                    <file-upload
                                        tip="点击上传学生头像"
                                        action="file/upload"
                                        :limit="1"
                        ...
                        -->
                        <el-form-item label="学生邮箱" class="input" v-if="tableName=='xuesheng'">
                            <el-input v-model="ruleForm.xueshengEmail" autocomplete="off" placeholder="学生邮箱"  />
                        </el-form-item>
                        <!--
    ...
    export default {
        ...
        methods: {
            ...
            login() {
                            ...
                            // laoshi 中的 工号 判空处理
                            // if('laoshi' == this.tableName && (this.ruleForm.laoshiUuidNumber== null ||this.ruleForm.laoshiUuidNumber== "")){
                            ...
                            // }
                            // laoshi 中的 院部 判空处理
                            // if('laoshi' == this.tableName && (this.ruleForm.yuanbuTypes== null ||this.ruleForm.yuanbuTypes== "")){
                            //     this.$message.error("院部不能为空");
                            //     return
                            // }
...
<style lang="scss" scoped>
	...
	.container {
		...
		background-image: url(/kaowubaoming/img/back-img-bg.jpg);
