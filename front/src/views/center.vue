  ...
  <div>
    ...
    >  
     <el-row>
         ...
         <el-col :span="12">
             <el-form-item v-if="flag=='laoshi'"  label='院部' prop="yuanbuTypes">
                 <el-select v-model="ruleForm.yuanbuTypes"  placeholder='请选择院部'>
                     <el-option
...
// 注册表 老师 的级联表
  ...
  methods: {
    ...
    onUpdateHandler() {
                         ...
                         if((!this.ruleForm.yuanbuTypes)&& 'laoshi'==this.flag){
