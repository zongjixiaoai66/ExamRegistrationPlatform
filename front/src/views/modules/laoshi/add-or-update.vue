        ...
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="院部" prop="yuanbuTypes">
                        <el-select v-model="ruleForm.yuanbuTypes" :disabled="ro.yuanbuTypes" placeholder="请选择院部">
                            <el-option
                                v-for="(item,index) in yuanbuTypesOptions"
                                v-bind:key="item.codeIndex"
                                :label="item.indexName"
                                :value="item.codeIndex">
                            </el-option>
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="院部" prop="yuanbuValue">
                        <el-input v-model="ruleForm.yuanbuValue"
    ...
    export default {
        data() {
            return {
                ...
                rules: {
                   ...
                   yuanbuTypes: [
                              { required: true, message: '院部不能为空', trigger: 'blur' },
                              {  pattern: /^[0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
        ...
        created() {
            ...
            //获取下拉框信息
                ...
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=yuanbu_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.yuanbuTypesOptions = data.data.list;
                    }
                });
