               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="考试区域" prop="kaoshiQuyu">
                       <el-input v-model="ruleForm.kaoshiQuyu"
                                 placeholder="考试区域" clearable  :readonly="ro.kaoshiQuyu"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="考试人数" prop="kaoshiRenshu">
                       <el-input v-model="ruleForm.kaoshiRenshu"
                                 placeholder="考试人数" clearable  :readonly="ro.kaoshiRenshu"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="考试介绍" prop="kaoshiContent">
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.kaoshiContent" label="考试介绍" prop="kaoshiContent">
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   kaoshiQuyu: [
                              { required: true, message: '考试区域不能为空', trigger: 'blur' },
                          ],
                   kaoshiTypes: [
                   ...
                   kaoshiContent: [
                              { required: true, message: '考试介绍不能为空', trigger: 'blur' },
                          ],
                   insertTime: [
        ...
        methods: {
            ...
            info(id) {
                ...
                _this.$http({
                    ...
                    if (data && data.code === 0) {
                        ...
                        _this.ruleForm.kaoshiContent = _this.ruleForm.kaoshiContent.replaceAll("src=\"upload/","src=\""+this.$base.url+"upload/");
                    } else {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.ruleForm.kaoshiContent = this.ruleForm.kaoshiContent.replaceAll(this.$base.url,"");
                        this.$http({
